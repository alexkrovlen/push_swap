...
static void	check_stack_rr_b_three(t_head *head_b)
{
	int c_step_max_s;
	int c_step_max_e;
...
static void	check_stack_rr_b_one(t_head *head_b)
{
	int c_step_max_s;
	int c_step_max_e;
